...
<label id="openokno" class="zagtext" style="color: rgb(128, 128, 0); border-radius: 11px 11px 0px 0px; top: inherit; bottom: 0px; left: 61%;">Оставь заявку</label>
...
<div class="resultokno"> <form action="" method="post" enctype="multipart/form-data" class="ui-sortable"> <span style=""><div class="zagtext" style="color: rgb(128, 128, 0);">Оставь заявку</div>
</span> <div class="elema konst" id="idelema0"> <div class="elemtext"><span style="color: #bd3500;font-size: 16px;font-weight: bold;">*</span>Номер телефона для обратной связи</div>
<input type="text" name="elemnamea0" class="dr" best="true"></div>
<div class="elemb konst" id="idelemb0"> <div class="elemtext">Что вас заинтересовало?</div>
<textarea name="elemnameb0" class="drt" style="margin: 0px; height: 26px; width: 340px;"></textarea></div>
<input class="drr" type="submit" name="dfotpr" value="Отправить заявку" style="background-color: rgb(0, 255, 0);"><div class="avtorc" style=""><a href="https://blogjquery.ru/" target="_blank" title="Программирование на jQuery, PHP, Joomla и WordPress">blogjquery.ru</a></div>
</form> </div>
...
$msg =
"*Номер телефона для обратной связи: ".$_POST["elemnamea0"]."\n<br />".
"Что вас заинтересовало?: ".$_POST["elemnameb0"]."\n<br />".
"";
